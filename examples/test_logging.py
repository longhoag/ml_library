...
def test_error_handling():
    ...
    try:
        ...
        raise ModelError("Failed to fit model", model_type="LinearModel", details={"epochs": 100})
    ...
    try:
        ...
        raise InvalidParameterError("n_estimators", -10, allowed_values="positive integers")
